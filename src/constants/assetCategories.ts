 ...
 * showInAssetLibrary: false 表示有专门处理界面（如角色设计），不在素材库显示
 */
import {
  PictureOutlined,
  AppstoreOutlined,
...
export const ASSET_CATEGORIES = [
  ...
  { value: 'character_sprite', label: '角色精灵图', showInAssetLibrary: false, icon: UserOutlined },
  { value: 'component', label: '元件', showInAssetLibrary: true, icon: AppstoreOutlined },
  { value: 'character_component', label: '角色元件', showInAssetLibrary: false, icon: UserOutlined },
  { value: 'video', label: '视频', showInAssetLibrary: true, icon: VideoCameraOutlined },
  { value: 'character_video', label: '角色视频', showInAssetLibrary: false, icon: UserOutlined },
