...
- **需求与界面**：`docs/01-功能文档.md`（含 1.1 术语表：工作区、画布/视口、播放器面板、时间线、素材条、占位指示条、选中时间轴、素材面板、功能面板、本地素材、预设素材、元件；用户习惯持久化 localStorage）
...
5. **2.5 剧情大纲**：集管理、概要/剧本编辑、Ant Design X 剧本专家 Chat、角色绑定。
6. **2.6 角色设计**：角色 CRUD、形象来源、AI 绘画、TTS 默认参数。
